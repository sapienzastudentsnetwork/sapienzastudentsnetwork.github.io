...
\*<i> ⚠️ Le informazioni su questo sito non sono legalmente vincolanti. Per i testi ufficiali si rimanda al [sito ufficiale dell'ateneo](https://www.uniroma1.it/it/) e alle pagine sul [Catalogo dei Corsi di Studio](https://corsidilaurea.uniroma1.it/it) (disponibili anche in [versione accessibile](https://cdl.sapienzastudents.net/)).</i>
...
<div class="home_evid">
    ...
    <div class="home_page" id="home_orari">
        <p class="home_box_text_title" id="home_orari_text">Orari</p>
        <p class="home_box_text">Orari delle lezioni</p>
        <button class="explore_more" onclick="window.location.href = 'insegnamenti/orari/'">Esplora&nbsp<i class="fa-solid fa-arrow-right"></i></button>
    </div>
</div>
