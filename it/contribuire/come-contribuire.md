...
docker run --rm -p 1313:1313 -v $(pwd):/app hugo-site # Genera i metadati delle sorgenti
docker run --rm -p 1313:1313 -e GENERATE_SOURCE_METADATA=false -v $(pwd):/app hugo-site # Disabilita la generazione
```
