...
- 6 credits for the [Complementary Educational Activity (AFC)](/compsci/info/study-plan/afc/), which may be a seminar, an individual project agreed with a lecturer, an additional exam recorded as an AFC, or a recognised external activity;
...
1. **Recommended Study Plan ("`PERCORSO FORMATIVO CONSIGLIATO`", Based on PCCs)**  
   ...
   - Include the **[AFC](/compsci/info/study-plan/afc/)**;
