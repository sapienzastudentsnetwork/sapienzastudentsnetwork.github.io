...
**Rejection reasons:** basic electives, unjustified non-STEM courses (for example, courses related to management), unbalanced yearly load, missing mandatory items, or overlapping content (for example, multiple identical words in course names).
