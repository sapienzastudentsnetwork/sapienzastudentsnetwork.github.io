...
There's only a practical distinction between first and second semester courses, apart from the [Complementary Educational Activity (AFC)](/compsci/info/study-plan/afc/) and the final exam.
...
|-------------|------------|----------|-----|
| `AAF1246`   | [AFC](/compsci/info/study-plan/afc/) | First    | 6   |
