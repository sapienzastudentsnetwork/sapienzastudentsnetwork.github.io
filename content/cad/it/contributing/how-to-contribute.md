...
{{% hint tip %}}
<i class="fa-solid fa-lightbulb" style="color: #238636;"></i> **Scegli il percorso più semplice**
...
{{% hint info %}}
<i class="fa-solid fa-circle-info" style="color: #74C0FC;"></i> **Il contenuto può trovarsi in un altro repository**
